...
Design your add-on to create required user files (like `config.json`) at runtime if they are missing. This prevents accidental commits of personal data.

## 3. Verification
1. Use your add-on normally in Anki.
